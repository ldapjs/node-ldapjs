...
const IntermediateResponse = require('./intermediate_response')
...
/**
 * Allows you to send a SearchEntry, SearchReference or IntermediateResponse back to the client.
 *
...
SearchResponse.prototype.send = function (entry, nofiltering) {
  ...
  const savedAttrs = {}
  let save = null
  if (entry instanceof SearchEntry || entry instanceof SearchReference || entry instanceof IntermediateResponse) {
