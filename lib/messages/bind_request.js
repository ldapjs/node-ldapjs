...
BindRequest.prototype._json = function (j, safePrint) {
  assert.ok(j);
  ...
  // safe flag indicate whether or not we should include the credentials
  // if the flag is not enabled, include the credentials
  if (!safePrint) {
