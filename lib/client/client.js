...
function Client(options) {
  ...
  this.localIpAddress = options.localIpAddress;
...
Client.prototype.connect = function connect() {
  ...
  function connectSocket(cb) {
    ...
    if (self.secure) {
      ...
      if (self.tlsOptions !== undefined) {
        self.tlsOptions.localAddress = self.localIpAddress;
      } else {
        self.tlsOptions = {"localAddress": self.localIpAddress};
      }
      ...
      if (self.localIpAddress !== undefined) {
        socket = net.createConnection({port: port, host: self.host, localAddress: self.localIpAddress});
      } else {
