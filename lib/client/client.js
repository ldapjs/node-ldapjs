...
const IntermediateResponse = require('../messages/intermediate_response')
...
Client.prototype.search = function search (base,
  ...
  function sendRequest (ctrls, emitter, cb) {
    const req = new SearchRequest({
      ...
      timeLimit: Object.hasOwnProperty.call(options, 'timeLimit') ? options.timeLimit : 10,
...
Client.prototype._sendSocket = function _sendSocket (message,
  ...
  function messageCallback (msg) {
    ...
    if (msg instanceof SearchEntry || msg instanceof SearchReference || msg instanceof IntermediateResponse) {
