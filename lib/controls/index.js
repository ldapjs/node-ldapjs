...
const SyncDoneControl = require('./sync_done_control')
const SyncRequestControl = require('./sync_request_control')
const SyncStateControl = require('./sync_state_control')
...
module.exports = {
  ...
  getControl: function getControl (ber) {
    ...
    switch (type) {
      ...
      case SyncDoneControl.OID:
        control = new SyncDoneControl(opts)
        break
      case SyncRequestControl.OID:
        control = new SyncRequestControl(opts)
        break
      case SyncStateControl.OID:
        control = new SyncStateControl(opts)
        break
  ...
  SyncRequestControl: SyncRequestControl,
