...
function Control (options) {
  ...
  // this code break in strict mode as most sub-classes only have a getter for value
  // using a try-catch allow to use Control on its own but prevents runtime exception for sub-classes
  try {
