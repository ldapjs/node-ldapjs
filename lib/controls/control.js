...
function Control (options) {
  ...
  // each sub-class needs to handle its value itself
  // this code break in streak mode as most sub-classes only have a getter for value
  // and have set options.value to null
